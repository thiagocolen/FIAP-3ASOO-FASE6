...
app.get('/', (req, res) => {
  res.send(
    ...
    '<hr>' +
    '<br>' +
    'http://fiap-3-asoo-fase-6-git-fiap.apps.na45.prod.nextcle.com/restaurantes/getAll' +
    '<br>' +
    '<ul>' +
    ...
    '<br>' + 
    '<br>' + 
    'For more details looking for README file on github repository' + 
    '<br>' + 
    'https://github.com/thiagocolen/FIAP-3ASOO-FASE6' + 
    '<br>' + 
